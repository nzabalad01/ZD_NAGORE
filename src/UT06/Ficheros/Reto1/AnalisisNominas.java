...
public class AnalisisNominas {
	public static void main(String[] args) {
        ...
        try (
             BufferedReader br = new BufferedReader(new FileReader("./src/UT06/Ficheros/Reto1/empleados.csv"))) {
        	 String linea;
        	 linea = br.readLine();
        ...
        try (BufferedWriter bw = new BufferedWriter(new FileWriter("./src/UT06/Ficheros/Reto1/informe_rrhh.txt", true));
